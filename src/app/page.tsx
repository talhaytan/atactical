...
// Dynamic import WebGL-heavy components with SSR disabled to prevent server-side render clashes on Vercel
const GunInspector = dynamic(() => import("../components/GunInspector"), {
  ssr: false,
});
